...
@RestController
@RequestMapping("/api/data-processor-kafka")
public class DataProcessorKafkaResource {

    private final Logger log = LoggerFactory.getLogger(DataProcessorKafkaResource.class);
    ...
    public DataProcessorKafkaResource(@Qualifier(KafkaSseProducer.CHANNELNAME) MessageChannel output) {
        this.output = output;
    }
