...
class PatientResourceIT {
    ...
    private static final String DEFAULT_MR = "AAAAAAAAAA";
    private static final String UPDATED_MR = "BBBBBBBBBB";

    private static final String DEFAULT_MR_PLUS_NAME = "AAAAAAAAAA";
    private static final String UPDATED_MR_PLUS_NAME = "BBBBBBBBBB";
    ...
    private static final String DEFAULT_BED = "AAAAAAAAAA";
    private static final String UPDATED_BED = "BBBBBBBBBB";
    ...
    public static Patient createEntity(EntityManager em) {
        Patient patient = new Patient()
            .mr(DEFAULT_MR)
            .mrPlusName(DEFAULT_MR_PLUS_NAME)
            .ward(DEFAULT_WARD)
            .room(DEFAULT_ROOM)
            .bed(DEFAULT_BED)
    ...
    public static Patient createUpdatedEntity(EntityManager em) {
        Patient patient = new Patient()
            .mr(UPDATED_MR)
            .mrPlusName(UPDATED_MR_PLUS_NAME)
            .ward(UPDATED_WARD)
            .room(UPDATED_ROOM)
            .bed(UPDATED_BED)
    ...
    void createPatient() throws Exception {
        ...
        assertThat(testPatient.getMr()).isEqualTo(DEFAULT_MR);
        assertThat(testPatient.getMrPlusName()).isEqualTo(DEFAULT_MR_PLUS_NAME);
        assertThat(testPatient.getWard()).isEqualTo(DEFAULT_WARD);
        assertThat(testPatient.getRoom()).isEqualTo(DEFAULT_ROOM);
        assertThat(testPatient.getBed()).isEqualTo(DEFAULT_BED);
    ...
    void getAllPatients() throws Exception {
        ...
        restPatientMockMvc
            ...
            .andExpect(jsonPath("$.[*].mr").value(hasItem(DEFAULT_MR)))
            .andExpect(jsonPath("$.[*].mrPlusName").value(hasItem(DEFAULT_MR_PLUS_NAME)))
    ...
    void getPatient() throws Exception {
        ...
        restPatientMockMvc
            ...
            .andExpect(jsonPath("$.mr").value(DEFAULT_MR))
            .andExpect(jsonPath("$.mrPlusName").value(DEFAULT_MR_PLUS_NAME))
    ...
    void putNewPatient() throws Exception {
        ...
        Patient testPatient = patientList.get(patientList.size() - 1);
        assertThat(testPatient.getMr()).isEqualTo(UPDATED_MR);
        assertThat(testPatient.getMrPlusName()).isEqualTo(UPDATED_MR_PLUS_NAME);
        assertThat(testPatient.getWard()).isEqualTo(UPDATED_WARD);
        assertThat(testPatient.getRoom()).isEqualTo(UPDATED_ROOM);
        assertThat(testPatient.getBed()).isEqualTo(UPDATED_BED);
