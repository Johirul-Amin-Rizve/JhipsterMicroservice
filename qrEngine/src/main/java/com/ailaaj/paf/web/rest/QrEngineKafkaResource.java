...
@RestController
@RequestMapping("/api/qr-engine-kafka")
public class QrEngineKafkaResource {

    private final Logger log = LoggerFactory.getLogger(QrEngineKafkaResource.class);
    ...
    public QrEngineKafkaResource(@Qualifier(KafkaSseProducer.CHANNELNAME) MessageChannel output) {
        this.output = output;
    }
