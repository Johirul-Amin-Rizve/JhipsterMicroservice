...
@RestController
@RequestMapping("/api/order-placer-kafka")
public class OrderPlacerKafkaResource {

    private final Logger log = LoggerFactory.getLogger(OrderPlacerKafkaResource.class);
    ...
    public OrderPlacerKafkaResource(@Qualifier(KafkaSseProducer.CHANNELNAME) MessageChannel output) {
        this.output = output;
    }
