...
@RestController
@RequestMapping("/api/pos-integration-kafka")
public class PosIntegrationKafkaResource {

    private final Logger log = LoggerFactory.getLogger(PosIntegrationKafkaResource.class);
    ...
    public PosIntegrationKafkaResource(@Qualifier(KafkaSseProducer.CHANNELNAME) MessageChannel output) {
        this.output = output;
    }
